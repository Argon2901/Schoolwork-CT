...
0000039b <getSwtchCnt>:
SYSCALL(getSwtchCnt)
 39b:	b8 1b 00 00 00       	mov    $0x1b,%eax
 3a0:	cd 40                	int    $0x40
 3a2:	c3                   	ret    

000003a3 <vaddr2phyaddr>:
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba b5 07 00 00       	mov    $0x7b5,%edx
        while(*s != 0){
 ...
 601:	a1 cc 0a 00 00       	mov    0xacc,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 cc 0a 00 00    	mov    %edx,0xacc
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 cc 0a 00 00    	mov    %edx,0xacc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d cc 0a 00 00    	mov    0xacc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 cc 0a 00 00    	mov    0xacc,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 cc 0a 00 00    	mov    %edx,0xacc
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 cc 0a 00 00 d0 	movl   $0xad0,0xacc
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf d0 0a 00 00       	mov    $0xad0,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 d0 0a 00 00 d0 	movl   $0xad0,0xad0
 766:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 d4 0a 00 00 00 	movl   $0x0,0xad4
 772:	00 00 00 
    if(p->s.size >= nunits){
