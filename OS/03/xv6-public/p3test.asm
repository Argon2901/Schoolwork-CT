...
_p3test:     file format elf32-i386
...
int main(void) {
  ...
  p = malloc(16);
  1d:	6a 10                	push   $0x10
  1f:	e8 ac 06 00 00       	call   6d0 <malloc>
  printf(1,"Code vadd %x phy: %x\n\n", main, vaddr2phyaddr((char *)main));
  24:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  p = malloc(16);
  2b:	89 c3                	mov    %eax,%ebx
  printf(1,"Code vadd %x phy: %x\n\n", main, vaddr2phyaddr((char *)main));
  2d:	e8 b1 03 00 00       	call   3e3 <vaddr2phyaddr>
  32:	50                   	push   %eax
  ...
  47:	56                   	push   %esi
  48:	e8 96 03 00 00       	call   3e3 <vaddr2phyaddr>
  4d:	50                   	push   %eax
  4e:	56                   	push   %esi
  4f:	68 df 07 00 00       	push   $0x7df
  54:	6a 01                	push   $0x1
  56:	e8 45 04 00 00       	call   4a0 <printf>
  printf(1,"Data vadd %x phy: %x\n\n", &gData, vaddr2phyaddr((char *)&gData));
  5b:	83 c4 14             	add    $0x14,%esp
  5e:	68 50 0b 00 00       	push   $0xb50
  63:	e8 7b 03 00 00       	call   3e3 <vaddr2phyaddr>
  68:	50                   	push   %eax
  69:	68 50 0b 00 00       	push   $0xb50
  6e:	68 f7 07 00 00       	push   $0x7f7
  73:	6a 01                	push   $0x1
  75:	e8 26 04 00 00       	call   4a0 <printf>
  printf(1,"BSS vadd %x phy: %x\n\n", &gun, vaddr2phyaddr((char *)&gun));
  7a:	83 c4 14             	add    $0x14,%esp
  7d:	68 4c 0b 00 00       	push   $0xb4c
  82:	e8 5c 03 00 00       	call   3e3 <vaddr2phyaddr>
  87:	50                   	push   %eax
  88:	68 4c 0b 00 00       	push   $0xb4c
  8d:	68 0e 08 00 00       	push   $0x80e
  92:	6a 01                	push   $0x1
  94:	e8 07 04 00 00       	call   4a0 <printf>
  printf(1,"Heap vadd %x phy: %x\n\n", p, vaddr2phyaddr(p));
  99:	83 c4 14             	add    $0x14,%esp
  9c:	53                   	push   %ebx
  9d:	e8 41 03 00 00       	call   3e3 <vaddr2phyaddr>
  a2:	50                   	push   %eax
  a3:	53                   	push   %ebx
  a4:	68 24 08 00 00       	push   $0x824
  a9:	6a 01                	push   $0x1
  ab:	e8 f0 03 00 00       	call   4a0 <printf>

  exit();
  b0:	83 c4 20             	add    $0x20,%esp
  b3:	e8 5b 02 00 00       	call   313 <exit>
  b8:	66 90                	xchg   %ax,%ax
  ba:	66 90                	xchg   %ax,%ax
  bc:	66 90                	xchg   %ax,%ax
  be:	66 90                	xchg   %ax,%ax
...
000003db <getSwtchCnt>:
SYSCALL(getSwtchCnt)
 3db:	b8 1b 00 00 00       	mov    $0x1b,%eax
 3e0:	cd 40                	int    $0x40
 3e2:	c3                   	ret    

000003e3 <vaddr2phyaddr>:
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 519:	ff 24 85 44 08 00 00 	jmp    *0x844(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 3b 08 00 00       	mov    $0x83b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 54 0b 00 00       	mov    0xb54,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 54 0b 00 00    	mov    %edx,0xb54
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 54 0b 00 00    	mov    %edx,0xb54
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 54 0b 00 00    	mov    0xb54,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d 54 0b 00 00    	mov    0xb54,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 54 0b 00 00    	mov    0xb54,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 54 0b 00 00    	mov    %edx,0xb54
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 54 0b 00 00 58 	movl   $0xb58,0xb54
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf 58 0b 00 00       	mov    $0xb58,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 58 0b 00 00 58 	movl   $0xb58,0xb58
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 5c 0b 00 00 00 	movl   $0x0,0xb5c
 7b2:	00 00 00 
    if(p->s.size >= nunits){
