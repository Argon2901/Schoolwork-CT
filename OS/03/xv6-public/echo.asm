...
main(int argc, char *argv[])
{
  ...
  2e:	66 90                	xchg   %ax,%ax
  30:	68 8c 07 00 00       	push   $0x78c
  35:	83 c3 01             	add    $0x1,%ebx
  38:	50                   	push   %eax
  39:	68 8e 07 00 00       	push   $0x78e
  3e:	6a 01                	push   $0x1
  ...
  50:	68 8a 07 00 00       	push   $0x78a
  55:	50                   	push   %eax
  56:	68 8e 07 00 00       	push   $0x78e
  5b:	6a 01                	push   $0x1
  5d:	e8 fe 03 00 00       	call   460 <printf>
  62:	83 c4 10             	add    $0x10,%esp

  printf(1, "%d\n", get_mem_size());
  65:	e8 09 03 00 00       	call   373 <get_mem_size>
  6a:	83 ec 04             	sub    $0x4,%esp
  6d:	50                   	push   %eax
  6e:	68 88 07 00 00       	push   $0x788
  73:	6a 01                	push   $0x1
  75:	e8 e6 03 00 00       	call   460 <printf>
  exit();
  7a:	e8 54 02 00 00       	call   2d3 <exit>
  7f:	90                   	nop
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d9:	ff 24 85 9c 07 00 00 	jmp    *0x79c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba 93 07 00 00       	mov    $0x793,%edx
        while(*s != 0){
