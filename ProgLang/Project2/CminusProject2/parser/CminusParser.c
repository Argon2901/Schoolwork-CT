...
static const yytype_int16 yyrline[] =
{
     ...
     216,   223,   228,   235,   241,   247,   262,   268,   274,   278,
     282,   286,   290,   294,   298,   304,   325,   329,   336,   342,
     349,   355,   361,   368,   391,   401,   411,   417,   423,   429,
     433,   439,   444,   461,   479,   492,   497,   513,   528,   542,
     556,   571,   587,   592,   606,   622,   627,   642,   658,   674,
     679,   683,   690,   695,   701,   712
};
#endif
...
#line 1800 "CminusParser.c"
    break;

  case 48: /* SimpleExpr: SimpleExpr LE AddExpr  */
#line 529 "CminusParser.y"
                {
			char r = getAvailableRegister();
...
#line 1818 "CminusParser.c"
    break;

  case 49: /* SimpleExpr: SimpleExpr LT AddExpr  */
#line 543 "CminusParser.y"
                {
			char r = getAvailableRegister();
...
#line 1855 "CminusParser.c"
    break;

  case 51: /* SimpleExpr: SimpleExpr GT AddExpr  */
#line 572 "CminusParser.y"
                {
			char r = getAvailableRegister();
			sprintf(tempString, 	"slt $%d, $%d, $%d\n", 
									r, (yyvsp[0].reg), (yyvsp[-2].reg));
...
#line 1873 "CminusParser.c"
    break;

  case 52: /* AddExpr: MulExpr  */
#line 588 "CminusParser.y"
                {
			(yyval.reg) = (yyvsp[0].reg);
			//printf("<AddExpr> -> <MulExpr>\n");
		}
#line 1882 "CminusParser.c"
    break;

  case 53: /* AddExpr: AddExpr PLUS MulExpr  */
#line 593 "CminusParser.y"
                {
			char r = getAvailableRegister();
...
#line 1900 "CminusParser.c"
    break;

  case 54: /* AddExpr: AddExpr MINUS MulExpr  */
#line 607 "CminusParser.y"
                {
			char r = getAvailableRegister();
...
#line 1918 "CminusParser.c"
    break;

  case 55: /* MulExpr: Factor  */
#line 623 "CminusParser.y"
                {
			(yyval.reg) = (yyvsp[0].reg);
			//printf("<MulExpr> -> <Factor>\n");
		}
#line 1927 "CminusParser.c"
    break;

  case 56: /* MulExpr: MulExpr TIMES Factor  */
#line 628 "CminusParser.y"
                {
			char r = getAvailableRegister();
...
#line 1946 "CminusParser.c"
    break;

  case 57: /* MulExpr: MulExpr DIVIDE Factor  */
#line 643 "CminusParser.y"
                {
			char r = getAvailableRegister();
...
#line 1964 "CminusParser.c"
    break;

  case 58: /* Factor: Variable  */
#line 659 "CminusParser.y"
                { 
			//remake to find all 
			char r = getAvailableRegister();
...
#line 1984 "CminusParser.c"
    break;

  case 59: /* Factor: Constant  */
#line 675 "CminusParser.y"
                { 
			(yyval.reg) = (yyvsp[0].reg);
			//printf("<Factor> -> <Constant>\n");
		}
#line 1993 "CminusParser.c"
    break;

  case 60: /* Factor: IDENTIFIER LPAREN RPAREN  */
#line 680 "CminusParser.y"
                {	
...
#line 2052 "CminusParser.c"
    break;


#line 2056 "CminusParser.c"
