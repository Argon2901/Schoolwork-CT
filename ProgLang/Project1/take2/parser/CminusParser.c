...
{
       0,    96,    96,   100,   106,   111,   116,   122,   126,   132,
     138,   145,   149,   156,   161,   167,   171,   177,   183,   187,
     191,   195,   199,   203,   207,   213,   222,   226,   233,   239,
     246,   252,   258,   265,   273,   278,   285,   291,   297,   303,
     307,   313,   318,   323,   328,   335,   340,   345,   350,   355,
     360,   365,   372,   377,   382,   389,   394,   399,   406,   411,
     416,   420,   427,   432,   438,   445
};
#endif
...
#line 214 "CminusParser.y"
			...
			*a = (yyvsp[-1].d);
			SymPutField(symtab, (yyvsp[-3].s), "int", a);
			//printf("<Assignment> -> <Variable> <ASSIGN> <Expr> <SC>\n");
		}
#line 1437 "CminusParser.c"
    break;
...
#line 266 "CminusParser.y"
			...
			scanf("%d", a);
			printf("%d\n", *a);
			SymPutField(symtab, (yyvsp[-2].s), "int", a);
...
#line 407 "CminusParser.y"
                { 
			(yyval.d) = *((int*)SymGetField(symtab, (yyvsp[0].s), "int"));
			//printf("<Factor> -> <Variable>\n");
		}
#line 1725 "CminusParser.c"
    break;
...
#line 439 "CminusParser.y"
                { 
			(yyval.s) = Cminus_lval.s;
			//printf("<StringConstant> -> <STRING> %s\n", Cminus_lval.s);
		}
#line 1777 "CminusParser.c"
    break;

  case 65: /* Constant: INTCON  */
#line 446 "CminusParser.y"
                { 
			(yyval.d) = Cminus_lval.d;
			//printf("<Constant> -> <INTCON>\n");
		}
#line 1786 "CminusParser.c"
    break;


#line 1790 "CminusParser.c"
