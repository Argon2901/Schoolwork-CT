...
0000037b <getSwtchCnt>:
SYSCALL(getSwtchCnt)
 37b:	b8 1b 00 00 00       	mov    $0x1b,%eax
 380:	cd 40                	int    $0x40
 382:	c3                   	ret    

00000383 <vaddr2phyaddr>:
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 98 07 00 00 	jmp    *0x798(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba 8f 07 00 00       	mov    $0x78f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 9c 0a 00 00       	mov    0xa9c,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 9c 0a 00 00    	mov    %edx,0xa9c
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 9c 0a 00 00    	mov    %edx,0xa9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 9c 0a 00 00    	mov    0xa9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 9c 0a 00 00    	mov    0xa9c,%edx
 ...
 71c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 71f:	89 15 9c 0a 00 00    	mov    %edx,0xa9c
}
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 9c 0a 00 00 a0 	movl   $0xaa0,0xa9c
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf a0 0a 00 00       	mov    $0xaa0,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 a0 0a 00 00 a0 	movl   $0xaa0,0xaa0
 746:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 a4 0a 00 00 00 	movl   $0x0,0xaa4
 752:	00 00 00 
    if(p->s.size >= nunits){
