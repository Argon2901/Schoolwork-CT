...
0000042b <getSwtchCnt>:
SYSCALL(getSwtchCnt)
 42b:	b8 1b 00 00 00       	mov    $0x1b,%eax
 430:	cd 40                	int    $0x40
 432:	c3                   	ret    

00000433 <vaddr2phyaddr>:
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 569:	ff 24 85 58 08 00 00 	jmp    *0x858(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba 50 08 00 00       	mov    $0x850,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 a0 0d 00 00       	mov    0xda0,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 a0 0d 00 00    	mov    %edx,0xda0
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 a0 0d 00 00    	mov    %edx,0xda0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d a0 0d 00 00    	mov    0xda0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d a0 0d 00 00    	mov    0xda0,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 a0 0d 00 00    	mov    0xda0,%edx
 ...
 7e7:	0d 00 00 
    base.s.size = 0;
 7ea:	bf a4 0d 00 00       	mov    $0xda4,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 a8 0d 00 00 00 	movl   $0x0,0xda8
 802:	00 00 00 
    if(p->s.size >= nunits){
