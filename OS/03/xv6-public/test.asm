...
main(int argc, char *argv[])
{
  ...
  printf(1, "%d\n", get_mem_size());
  11:	e8 0d 03 00 00       	call   323 <get_mem_size>
...
0000034b <getSwtchCnt>:
SYSCALL(getSwtchCnt)
 34b:	b8 1b 00 00 00       	mov    $0x1b,%eax
 350:	cd 40                	int    $0x40
 352:	c3                   	ret    

00000353 <vaddr2phyaddr>:
 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 9c 07 00 00 	movzbl 0x79c(%edx),%edx
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 44 07 00 00 	jmp    *0x744(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 3c 07 00 00       	mov    $0x73c,%edx
        while(*s != 0){
 ...
 5b1:	a1 44 0a 00 00       	mov    0xa44,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 44 0a 00 00    	mov    %edx,0xa44
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 44 0a 00 00    	mov    %edx,0xa44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 44 0a 00 00    	mov    0xa44,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 44 0a 00 00    	mov    0xa44,%edx
 ...
 6ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 44 0a 00 00    	mov    %edx,0xa44
}
 ...
 6ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 44 0a 00 00 48 	movl   $0xa48,0xa44
 707:	0a 00 00 
    base.s.size = 0;
 70a:	bf 48 0a 00 00       	mov    $0xa48,%edi
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 48 0a 00 00 48 	movl   $0xa48,0xa48
 716:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 4c 0a 00 00 00 	movl   $0x0,0xa4c
 722:	00 00 00 
    if(p->s.size >= nunits){
